...
def test_claw_safe(channel):
    print(f"\n--- Testing Channel {channel} (CLAW - SAFE MODE) ---")
    ...
    print("Sweeping slowly towards 60 degrees (closing?)...")
    for a in range(90, 59, -1):
        pca.set_angle(channel, a)
        time.sleep(sweep_delay)
    time.sleep(1)
    
    print("Sweeping slowly towards 120 degrees (opening?)...")
...
# Test Claw (Channel 5) in safe mode between 60 and 120 degrees
test_claw_safe(5)
