...
def test_full_range_fast(channel):
    print(f"\n--- Testing Channel {channel} (FAST MODE) ---")
    ...
    print("Sweeping fast towards 0 degrees...")
    for a in range(90, -1, -1):
        pca.set_angle(channel, a)
        time.sleep(sweep_delay)
    time.sleep(1)
    
    print("Sweeping fast towards 180 degrees...")
...
# Test Up/Down (Channel 4) fast all the way to 0 and 180
test_full_range_fast(4)
